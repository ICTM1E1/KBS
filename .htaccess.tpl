...
RewriteRule ^client/login$ /client/login.php [NC]
RewriteRule ^client/home$ /client/index.php?p=home
RewriteRule ^client/agenda$ /client/index.php?p=agenda
RewriteRule ^client/berichten$ /client/index.php?p=messages
RewriteRule ^client/logout$ /client/login.php?action=logout [NC]
